...
public class OrderServiceImpl implements OrderService {
	...
	public List<Order> findOrderByStatus(int status) {
		...
		return this.orderDao.findOrderByStatus(status);
	}
	...
	@Override
	public Order findOrderByStatusAndRoomid(int status, Integer roomid) {

		return (Order) this.orderDao.findOrderByStatusAndRoomid(status, roomid);
	}
}
