...
public class OrderServiceAction extends ActionSupport {
	...
	public String delete() {
		...
		User user = (User) session.getAttribute("user");
		// 删除订单
		Order deleteOrder = this.orderService.findOrderById(order.getOrderid());
		this.orderService.removeOrder(deleteOrder);
		// 设置房间为空，无客人
		Room roomUser = this.roomService.findRoomById(deleteOrder.getRoomid());
