...
<body>
	...
	<h1>
		<font color="red"><center>所有空闲车位</center> </font>
	</h1>
	...
	<table border="1" width="80%" align="center">
		...
		<s:iterator value="#request.intheparkfree" id="parkcar">
			<tr>
				<td><s:property value="#parkcar.parkid" /></td>

				<td><s:if test="#parkcar.status == 0">空闲</s:if> <%--  						<s:elseif test="#room.status == 2">预定未入住</s:elseif>  --%>
					<s:else>已占用</s:else></td>
