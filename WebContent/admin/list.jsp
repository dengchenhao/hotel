...
<body>
	...
	<h1>
		<font color="red"><center>用户列表</center> </font>
	</h1>
	<table border="1" width="80%" align="center" class="table">
		...
		<s:iterator value="#request.list" id="us">
			<tr>
				...
				<td><s:a href="deleteUser.action?user.userid=%{#us.userid}"
						onclick="return del();">delete</s:a></td>
				<td><s:a href="updatePUser.action?user.userid=%{#us.userid}">update</s:a>
				</td>
			</tr>
		</s:iterator>
	</table>
